static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(  // Layer2: unconvenient keys on right hand, leftled:top/white
        // left hand
        ...
        */
        ...
        // right hand
             NO,  NO, FN1, FN2, FN7, FN8,   FN3,
             TRNS,FN4, FN5, FN6, FN7, FN8,   EQL,
                  FN9, FN5, FN10, QUOT, SCLN, BSLS  ,
             TRNS,FN11, LBRC, FN12, FN13, RBRC,   BSLS,
    ...
    KEYMAP(  // Layer3: F-keys instead of numbers, leftled:top/white
        // left hand
        ...
        // right hand
             ...
             TRNS,P6,  P7,  P8,  P9,  P0,  PGUP,
                  TRNS,U,   TRNS,TRNS,TRNS,PGDN,
             TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
                       TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,TRNS,
        TRNS,
    ...
    KEYMAP(  // Layer4: F-keys + utils(Teensy, Workman-layer switch), leftled:top/white+onboard
        // left hand
    ...
    KEYMAP(  // Layer6: application-specific shortcuts (mostly browser), leftled:top/white+bot/green
        // left hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,
        TRNS,NO,  NO,  NO,  NO,  NO,  TRNS,
        TRNS,NO,  NO,  NO,  NO,  NO,
...
static const uint16_t PROGMEM fn_actions[] = {
    ...
    [1] =   ACTION_MODS_KEY(MOD_LSFT, KC_QUOT),             // FN1  = Shifted BackSlash // " in Workman
    [2] =   ACTION_MODS_KEY(MOD_LSFT, KC_BSLS),             // FN2  = Shifted Minus     // \ in Workman
    ...
    [18] =  ACTION_LAYER_SET(4, ON_BOTH),                   // FN18 - Teensy and F* keys
    ...
    [28] =  ACTION_LAYER_TAP_KEY(2, KC_A),                  // FN28 = momentary Layer4 on A key, to use with unconvenient keys
    ...
    [31] =  ACTION_LAYER_TAP_KEY(1, KC_F),                  // FN31 = momentary Layer2 on F key, to use with Numpad keys
...
static const uint16_t PROGMEM fn_actions_4[] = {
    ...
    [3] = ACTION_MODS_KEY(MOD_LSFT, KC_EQL),
    [4] = ACTION_MODS_KEY(MOD_LSFT, KC_6),
    [5] = ACTION_MODS_KEY(MOD_LSFT, KC_1),
    [6] = ACTION_MODS_KEY(MOD_LSFT, KC_SLSH),
    ...
    [12] = ACTION_MODS_KEY(MOD_LSFT, KC_KOMM),
